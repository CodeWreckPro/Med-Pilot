...
The Med-Pilot system follows a multi-agent architecture with specialized components for data ingestion, processing, and intelligent analysis:
...
```env
DATABASE_URL=postgresql://username:password@localhost:5432/Med-Pilot
